...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript">
        ...
        jq(function () {
            ...
            //2.通过cookie获取用户名称  从另外一个项目中获取值，存在跨域问题
            jq.post("http://localhost:9005/getLoginName",{"token":token},function (data) {
                if (data==""){
                    jq("#showLogin").html('你好，请&lt;a href="Login.html">登录&lt;/a>');
                }else {
                    jq("#showLogin").html('你好，'+data);
                }
            });
        })
    </script>
...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl"><span id="showLogin"></span>&nbsp; <a href="Regist.html" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
            ...
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    ...
                    <c:forEach items="${list}" var="l">
                        <li><a href="${l.url}"><img src="${l.pic}" width="740" height="401" /></a></li>
                    </c:forEach>
...
<div class="top">
    ...
    <div class="search">
        ...
        <%--搜所栏--%>
        <form action="http://localhost:9003/search" name="s" method="get">
            <input type="text" name="title" value="" class="s_ipt" />
            <input type="submit" value="搜索" class="s_btn" />
        </form>
