...
<div class="top">
    ...
    <div class="search">
        ...
        <%--搜所栏--%>
    	<form action="search" id="form1" name="form" method="post">
        	<input type="text" name="title" value="${title}" class="s_ipt" />
                ...
                <ul class="cate_list">
                	<c:forEach items="${list}" var="p">
                        <li>
                            <div class="img">
                                <a href="#">
                                    <img src="images/per_3.jpg" width="210" height="185"/>
                                </a>
                            </div>
                            <div class="price">
                                <font>
